...
import { declareToss, startInnings, recordBall, selectNextPlayer, undoLastBall, getLiveMatch, resetMatch } from "../controllers/live-scoring.controller.js";
...
fixtureRouter.post("/:id/fixtures/:fixtureId/innings/:inningsId/balls", requireAuth, recordBall);
fixtureRouter.patch("/:id/fixtures/:fixtureId/innings/:inningsId/next-player", requireAuth, selectNextPlayer);
fixtureRouter.delete("/:id/fixtures/:fixtureId/innings/:inningsId/balls/last", requireAuth, undoLastBall);
fixtureRouter.get("/:id/fixtures/:fixtureId/live", requireAuth, getLiveMatch);
fixtureRouter.post("/:id/fixtures/:fixtureId/reset", requireAuth, resetMatch);
